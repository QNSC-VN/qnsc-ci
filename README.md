...
jobs:
  ...
  openapi:                          # rally-api only
    ...
    steps:
      ...
      - uses: nghiavan0610/rally-gitops/actions/publish-openapi-spec@main
        with:
...
jobs:
  deploy:
    ...
    steps:
      ...
      - uses: nghiavan0610/rally-gitops/actions/setup-aws-oidc@main
        id: aws
        with:
      ...
      - uses: nghiavan0610/rally-gitops/actions/attest-image@main
        with:
    ...
    steps:
      - uses: nghiavan0610/rally-gitops/actions/setup-aws-oidc@main
        with:
          ...
          region: ${{ vars.AWS_REGION }}
      - uses: nghiavan0610/rally-gitops/actions/ecr-cleanup@main
        with:
          repositories: |
            rally-api
            rally-worker
...
uses: nghiavan0610/rally-gitops/actions/setup-node-pnpm@v1
